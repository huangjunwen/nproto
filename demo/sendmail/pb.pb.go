...
func (x *EmailEntry) GetCreatedAt() int64 {
	if x != nil {
		return x.CreatedAt
	}
	return 0
...
func (x *EmailEntry) GetEndedAt() int64 {
	if x != nil {
		return x.EndedAt
	}
	return 0
...
var file_pb_proto_rawDesc = []byte{
	...
	0x64, 0x5f, 0x61, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x03, 0x52, 0x07, 0x65, 0x6e, 0x64, 0x65,
