...
func (*MetaDataKV) Descriptor() ([]byte, []int) {
	return fileDescriptor_md_840f4dd8df841c35, []int{0}
}
...
func init() { proto.RegisterFile("md.proto", fileDescriptor_md_840f4dd8df841c35) }

var fileDescriptor_md_840f4dd8df841c35 = []byte{
